...
class DailyWorkReportBottomWidget extends StatelessWidget {

  const DailyWorkReportBottomWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var controller = Get.find<DailyWorkReportController>();
