...
class HeavyMaterialHandlingWorkPlanBottomWidget extends StatelessWidget {

  const HeavyMaterialHandlingWorkPlanBottomWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var controller = Get.find<HeavyMaterialHandlingWorkPlanController>();
