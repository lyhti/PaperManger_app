...
class Inspection258kvGirsBottomWidget extends StatelessWidget {

  const Inspection258kvGirsBottomWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var controller = Get.find<Inspection258kvGirsController>();
