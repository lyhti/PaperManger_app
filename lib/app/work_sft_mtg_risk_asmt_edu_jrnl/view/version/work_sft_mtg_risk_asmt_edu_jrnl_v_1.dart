...
class WorkSafetyMeetingRiskAssessmentEducationJournalV1 extends GetView<WorkSafetyMeetingRiskAssessmentEducationJournalController> {
  final global = Get.find<GlobalService>();

  WorkSafetyMeetingRiskAssessmentEducationJournalV1({Key? key}) : super(key: key);
