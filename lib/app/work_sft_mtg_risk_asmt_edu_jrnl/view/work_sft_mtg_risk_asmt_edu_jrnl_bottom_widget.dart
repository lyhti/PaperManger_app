...
class WorkSafetyMeetingRiskAssessmentEducationJournalBottomWidget  extends StatelessWidget {

  const WorkSafetyMeetingRiskAssessmentEducationJournalBottomWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var controller = Get.find<WorkSafetyMeetingRiskAssessmentEducationJournalController>();
