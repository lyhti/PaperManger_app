...
import 'package:Paper_Manager/app/work_sft_mtg_risk_asmt_edu_jrnl/view/version/work_sft_mtg_risk_asmt_edu_jrnl_v_2.dart';
...
import 'version/work_sft_mtg_risk_asmt_edu_jrnl_v_1.dart';

class WorkSafetyMeetingRiskAssessmentEducationJournalViewWidget   extends GetView<WorkSafetyMeetingRiskAssessmentEducationJournalController> {
  WorkSafetyMeetingRiskAssessmentEducationJournalViewWidget({Key ? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WorkSafetyMeetingRiskAssessmentEducationJournalController>(init: WorkSafetyMeetingRiskAssessmentEducationJournalController(), builder: (controller) {
      if(controller.isInitialized.value == false) {
        return const CircularLoadingWidget(height: 70);
      } else {
        switch(controller.viewVersion.value) {
          case 1:
            return WorkSafetyMeetingRiskAssessmentEducationJournalV1();

          case 2:
            return WorkSafetyMeetingRiskAssessmentEducationJournalV2();
