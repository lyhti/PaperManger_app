...
class WorkSafetyMeetingRiskAssessmentEducationJournal1Controller  extends GetxController with GetTickerProviderStateMixin {
  ...
  initState() async {
    logger.d('WorkSafetyMeetingRiskAssessmentEducationJournal1Controller - initState');
    try {
      docColList.clear();
