...
class WorkSafetyMeetingRiskAssessmentEducationJournal1V2 extends GetView<WorkSafetyMeetingRiskAssessmentEducationJournal1Controller> {
  final global = Get.find<GlobalService>();

  WorkSafetyMeetingRiskAssessmentEducationJournal1V2({Key? key}) : super(key: key);
