...
import 'version/work_sft_mtg_risk_asmt_edu_jrnl_1_v_1.dart';
import 'version/work_sft_mtg_risk_asmt_edu_jrnl_1_v_2.dart';

class WorkSafetyMeetingRiskAssessmentEducationJournal1ViewWidget   extends GetView<WorkSafetyMeetingRiskAssessmentEducationJournal1Controller> {
  WorkSafetyMeetingRiskAssessmentEducationJournal1ViewWidget({Key ? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WorkSafetyMeetingRiskAssessmentEducationJournal1Controller>(init: WorkSafetyMeetingRiskAssessmentEducationJournal1Controller(), builder: (controller) {
      if(controller.isInitialized.value == false) {
        return const CircularLoadingWidget(height: 70);
      } else {
        switch(controller.viewVersion.value) {
          case 1:
            return WorkSafetyMeetingRiskAssessmentEducationJournal1V1();

          case 2:
            return WorkSafetyMeetingRiskAssessmentEducationJournal1V2();
