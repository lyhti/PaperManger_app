...
import '../work_sft_mtg_risk_asmt_edu_jrnl_2_bottom_widget.dart';

class WorkSafetyMeetingRiskAssessmentEducationJournal2V1 extends GetView<WorkSafetyMeetingRiskAssessmentEducationJournal2Controller> {
  final global = Get.find<GlobalService>();

  WorkSafetyMeetingRiskAssessmentEducationJournal2V1({Key? key}) : super(key: key);
