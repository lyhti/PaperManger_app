...
class WorkSafetyMeetingRiskAssessmentEducationJournal1BottomWidget  extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var controller = Get.find<WorkSafetyMeetingRiskAssessmentEducationJournal2Controller>();
          ...
          children: [
            TextButton(
                onPressed: () async {
                  ...
                  if (check == 'agree') {
                    var cstrnNm = controller.textController['cstrn_nm']?.text;

                    if (cstrnNm == null || cstrnNm == '') {
            ...
            TextButton(
                onPressed: () async {
                  ...
                  if (check == 'agree') {
                    ...
                    if (cstrnNm == null || cstrnNm == '') {
                      Util.alert('공사명을 입력해주세요.', callback: () async {
                        controller.focusNode['cstrn_nm']?.requestFocus();
                      });
                    } else {
                      Util.overlayLoaderStart(context);
